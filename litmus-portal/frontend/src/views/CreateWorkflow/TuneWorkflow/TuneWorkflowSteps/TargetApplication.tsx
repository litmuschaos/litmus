...
const TargetApplication = React.forwardRef<unknown, TargetApplicationProp>(
  ({ isCustom, engineIndex }, ref) => {
    ...
    return (
      <div>
        ...
        <Typography className={classes.annotationDesc}>
          ...
          Ideally, you cannot run this experiment unless the annotation is
          patched to the application. However, this service account has the
          privileges to disable the enforcement of annotation checks. Mark the
          annotation as false to proceed.
        </Typography>
      </div>
    );
  }

...
> Litmus-2.0.0 (Stable)
```bash
kubectl apply -f https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.0.0/litmus-2.0.0.yaml
```
...
curl https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.0.0/litmus-namespaced-2.0.0.yaml --output litmus-portal-namespaced-k8s-template.yml
...
> Litmus-2.0.0 (Stable)
```bash
kubectl delete -f https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.0.0/litmus-2.0.0.yaml
```

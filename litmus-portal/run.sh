...
export SUBSCRIBER_IMAGE=litmuschaos/litmusportal-subscriber:1.10.0
...
export LITMUS_CHAOS_OPERATOR_IMAGE=litmuschaos/chaos-operator:1.10.0
export LITMUS_CHAOS_RUNNER_IMAGE=litmuschaos/chaos-runner:1.10.0

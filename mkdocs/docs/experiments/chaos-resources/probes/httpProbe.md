...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/litmus/master/docs/experiments/chaos-resources/probes/httpProbe/http-get.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/litmus/master/docs/experiments/chaos-resources/probes/httpProbe/http-post-with-body.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/litmus/master/docs/experiments/chaos-resources/probes/httpProbe/http-post-with-bodyPath.yaml yaml)
```yaml
# contains the http probes with post method and verify the response code
apiVersion: litmuschaos.io/v1alpha1
kind: ChaosEngine
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/litmus/master/docs/experiments/chaos-resources/probes/httpProbe/http-responseTimeout.yaml yaml) 
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/litmus/master/docs/experiments/chaos-resources/probes/httpProbe/http-insecureSkipVerify.yaml yaml)
```yaml

...
!!! tip "Scenario: Inject network latency to Spring Boot Application"    
    ![Spring Boot Latency](../../images/spring-boot-latency.png)
...
??? info "Verify the prerequisites" 
    ...
    -  Ensure that the <code> spring-boot-latency </code> experiment resource is available in the cluster by executing <code>kubectl get chaosexperiments</code> in the desired namespace. If not, install from <a href="https://hub.litmuschaos.io/api/chaos/master?file=charts/spring-boot/spring-boot-latency/experiment.yaml">here</a>

...
#### *Leia esse README em [outras línguas](./TRANSLATIONS.md).*
...
- Alguns experimentos de caos fazem uso da Docker API de dentro dos pods de experimento, e portanto precisando que o socket do Docker esteja montado. A discrição do usuário é recomendada ao permitir que desenvolvedores/admins devops/SREs acessem/executem esses experimentos.
...
Litmus é licenciado através da Apache License, Version 2.0. Veja [LICENSE](../LICENSE) para o texto completo da licença. Alguns dos projetos utilizados pelo projeto Litmus podem ter uma licença diferente, então, nesses casos, refira-se a cada licença específica.

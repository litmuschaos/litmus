...
var MutationRbacRules = map[string][]string{
	...
	"acceptInvitation":        {string(entities.RoleOwner), string(entities.RoleViewer), string(entities.RoleExecutor), string(entities.RoleEditor)}, 
	"declineInvitation":       {string(entities.RoleOwner), string(entities.RoleViewer), string(entities.RoleExecutor), string(entities.RoleEditor)},
	"removeInvitation":        {string(entities.RoleOwner)},
	"leaveProject":            {string(entities.RoleOwner), string(entities.RoleViewer), string(entities.RoleExecutor), string(entities.RoleEditor)},

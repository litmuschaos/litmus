...
// ProcessExperiment provides a mock function with given fields: workflow, projectID, revID
func (_m *ChaosExperimentService) ProcessExperiment(workflow *model.ChaosExperimentRequest, projectID string, revID string) (*model.ChaosExperimentRequest, *chaos_experiment.ChaosExperimentType, error) {
	ret := _m.Called(workflow, projectID, revID)
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(*model.ChaosExperimentRequest, string, string) (*model.ChaosExperimentRequest, *chaos_experiment.ChaosExperimentType, error)); ok {
		return rf(workflow, projectID, revID)
	}
	if rf, ok := ret.Get(0).(func(*model.ChaosExperimentRequest, string, string) *model.ChaosExperimentRequest); ok {
		r0 = rf(workflow, projectID, revID)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*model.ChaosExperimentRequest, string, string) *chaos_experiment.ChaosExperimentType); ok {
		r1 = rf(workflow, projectID, revID)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(*model.ChaosExperimentRequest, string, string) error); ok {
		r2 = rf(workflow, projectID, revID)
	} else {
		r2 = ret.Error(2)
	}
...
//   - projectID string
//   - revID string
func (_e *ChaosExperimentService_Expecter) ProcessExperiment(workflow interface{}, projectID interface{}, revID interface{}) *ChaosExperimentService_ProcessExperiment_Call {
	return &ChaosExperimentService_ProcessExperiment_Call{Call: _e.mock.On("ProcessExperiment", workflow, projectID, revID)}
}

func (_c *ChaosExperimentService_ProcessExperiment_Call) Run(run func(workflow *model.ChaosExperimentRequest, projectID string, revID string)) *ChaosExperimentService_ProcessExperiment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*model.ChaosExperimentRequest), args[1].(string), args[2].(string))
	})
	return _c
}
...
func (_c *ChaosExperimentService_ProcessExperiment_Call) RunAndReturn(run func(*model.ChaosExperimentRequest, string, string) (*model.ChaosExperimentRequest, *chaos_experiment.ChaosExperimentType, error)) *ChaosExperimentService_ProcessExperiment_Call {
	_c.Call.Return(run)
	return _c
}

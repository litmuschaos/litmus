...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/nodes/docker-service-kill/docker-service-kill.yaml yaml)
```yaml

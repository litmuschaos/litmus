...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-duplication/network-duplication.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-duplication/destination-ips-and-hosts.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-duplication/network-interface.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-duplication/container-runtime-and-socket-path.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-duplication/pumba-lib.yaml yaml)
```yaml

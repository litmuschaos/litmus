...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/common/target-pods.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/common/pod-affected-percentage.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/common/target-container.yaml yaml)
```yaml

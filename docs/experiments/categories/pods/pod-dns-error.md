...
??? info "Verify the prerequisites" 
    ...
    -  Ensure that the <code>pod-dns-error</code> experiment resource is available in the cluster by executing <code>kubectl get chaosexperiments</code> in the desired namespace. If not, install from <a herf="https://hub.litmuschaos.io/api/chaos/master?file=charts/generic/pod-dns-error/experiment.yaml">here</a> 
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-dns-error/target-hostnames.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-dns-error/match-scheme.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-dns-error/container-runtime-and-socket-path.yaml yaml)
```yaml

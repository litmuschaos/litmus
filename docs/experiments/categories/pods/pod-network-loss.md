...
!!! tip "Scenario: Induce network loss of the target pod"    
    ![Pod Network Loss](../../images/network-chaos.png)
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-loss/network-loss.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-loss/destination-ips-and-hosts.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-loss/network-interface.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-loss/container-runtime-and-socket-path.yaml yaml)
```yaml
...
[embedmd]:# (https://raw.githubusercontent.com/ispeakc0de/litmus/experiment-docs/docs/experiments/categories/pods/pod-network-loss/pumba-lib.yaml yaml)
```yaml
